...
async function connectionUpdate(update) {
  ...
  if (update.receivedPendingNotifications) conn.sendMessage(`6287769811262@s.whatsapp.net`, {text: 'BOT TELAH BERHASIL TERHUBUNG!' })
}
...
global.reloadHandler = function (restatConn) {
  ...
  conn.welcome = 'Halo @user ! Selamat datang di grup @subject' 
  conn.bye = 'Selamat Tinggal @user 👋'
  conn.spromote = '@user Selamat udah jadi admin!'
  conn.sdemote = '@user Bye!! Kamu bukan admin lagi.'
...
async function _quickTest() {
  ...
  if (!s.ffmpeg) conn.logger.warn('Kamu harus insatall ffmpeg untuk mengirim sebuah video')
