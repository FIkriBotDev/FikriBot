        ...
        try {
            ...
            try {
                ...
                if (user) {
                    ...
                    if (!isNumber(user.goldenapple)) user.goldenapple = 0
                    ...
                    try {
                        ...
                        if (e) {
                            ...
                            if (e.name) for (let [jid] of global.owner.filter(([number, isCreator, isDeveloper]) => isDeveloper && number)) {
                                ...
                                if (data.exists) m.reply(`*Plugin:* ${m.plugin}\n*Sender:* ${m.sender}\n*Chat:* ${m.chat}\n*Command:* ${usedPrefix}${command} [Error: ENOENT: no such file or directory]`.trim(), data.jid)
                            }
                            m.reply(text)
                        }
                    } finally {
    ...
    async participantsUpdate({ id, participants, action }) {
        ...
        switch (action) {
            ...
            case 'remove':
                ...
                break
        case 'ytmp4': case 'ytv': {
if (!q) throw `Example : ${prefix + command} https://youtu.be/a8yLJ_Hh4o8 360p`
...
global.dfail = (type, m, conn) => {
    let msg = {
        ...
        premium: '*Fitur Khusus Premium!*\nFree Trial 10Days Premium: http://web.fikribot.rf.gd/freetrial/\n\n~FikriBot', 
