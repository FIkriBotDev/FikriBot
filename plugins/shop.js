...
const Beleksirb = 500
const Bgoldenapple = 100000
const Sgoldenapple = 30000
...
============================
*Terbaru    |  Harga Beli*
Golden Apple:     ${Bgoldenapple}

*Terbaru*    |  *Harga Jual*
Golden Apple     ${Sgoldenapple}
============================
                 ...
                 case 'makanangriffin':
                  ...
                  case 'batu':
                    ...
                    case 'umpan':
                        ...
                        break 
                        case 'goldenapple':
                            if (global.db.data.users[m.sender].money >= Bgoldenapple * count) {
                                global.db.data.users[m.sender].goldenapple += count * 1
                                global.db.data.users[m.sender].money -= Bgoldenapple * count
                                conn.reply(m.chat, `Succes membeli ${count} Golden Apple dengan harga ${Bgoldenapple * count} money`, m)
                            } else conn.reply(m.chat, `Uang anda tidak cukup untuk membeli ${count} Golden Apple dengan harga ${Bgoldenapple * count} money`.trim(), m)
            ...
            case 'sell': 
                switch (_type) {
                    ...
                    case 'apel':
                        ...
                        break
                        case 'goldenapple':
                        if (global.db.data.users[m.sender].goldenapple >= count * 1) {
                            global.db.data.users[m.sender].goldenapple -= count * 1
                            global.db.data.users[m.sender].money += Sgoldenapple * count
                            conn.reply(m.chat, `Succes menjual ${count} Golden Apple, dan anda mendapatkan ${Sgoldenapple * count} money`, m)
                        } else conn.reply(m.chat, `Gapple anda tidak cukup`, m)
                        break
                   case 'berlian':
